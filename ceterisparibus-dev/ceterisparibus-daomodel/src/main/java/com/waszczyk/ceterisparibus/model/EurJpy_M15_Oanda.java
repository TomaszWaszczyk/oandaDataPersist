...
@Entity
@Table(name="eurjpy_m15_oanda")
public class EurJpy_M15_Oanda implements Serializable {

    @Id
    @SequenceGenerator(name = "EURJPY_M15_ID_GENERATOR", sequenceName = "EURJPY_M15_OANDA_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "EURJPY_M15_ID_GENERATOR")
    ...
    public boolean equals(Object o){
        if(o != null && o instanceof EurJpy_M15_Oanda){
            return openBid.equals(((EurJpy_M15_Oanda) o).openBid);
        }
