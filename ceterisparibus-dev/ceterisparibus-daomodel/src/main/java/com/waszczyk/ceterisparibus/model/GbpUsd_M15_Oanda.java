...
@Entity
@Table(name="gbpusd_m15_oanda")
public class GbpUsd_M15_Oanda implements Serializable{

    @Id
    @SequenceGenerator(name = "GBPUSD_M15_ID_GENERATOR", sequenceName="GBPUSD_M15_OANDA_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "GBPUSD_M15_ID_GENERATOR")
    ...
    public void setCandle_id(Long candleId) {
    ...
    public boolean equals(Object o){
        if(o != null && o instanceof GbpUsd_M15_Oanda){
            return openBid.equals(((GbpUsd_M15_Oanda) o).openBid);
        }
